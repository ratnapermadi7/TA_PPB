...
function White({ navigation }) {
  ...
  function getData() {
    const name = 'persia'; // You can replace this with the dynamic value if needed
  ...
  return (
    <View style={{ flex: 1, marginTop: 20 }}>
      <FlatList
        data={data}
        renderItem={({ item }) => (
          <TouchableOpacity onPress={() => navigation.navigate('Detail White Cat', { msg: item.id })}>
